        ...
        Group {
            ...
            case .utilities:
                UtilitiesView(
                    ...
                    screenOCR: model.screenOCR,
                    colorPicker: model.colorPicker,
                    screenRecorder: model.screenRecorder,
                    cameraPreview: model.cameraPreview,
                    keyboardDebounce: model.keyboardDebounce,
                    scrollDirection: model.scrollDirection,
                    mouseSideButtons: model.mouseSideButtons,
                    focusFollowsMouse: model.focusFollowsMouse,
                    superKey: model.superKey,
                    smoothScrolling: model.smoothScrolling,
                    plainTextPaste: model.plainTextPaste,
                    finderShortcuts: model.finderShortcuts,
                    scratchpad: model.scratchpad,
                    media: model.media,
                    displayControl: model.displayControl,
                    cleaningMode: model.cleaningMode,
                    selectedTab: Binding(
