...
public enum MacScopeMCPUtilityCatalog {
    public static let actions: [MacScopeMCPUtilityActionDescriptor] = [
        ...
        .init(id: "windows.launch-app", module: .windows, title: "Open installed application", summary: "Launch an installed application by its verified bundle identifier.", arguments: ["bundle_identifier": "Bundle identifier from current windows state."]),
        .init(id: "windows.quit-app", module: .windows, title: "Quit running application", summary: "Ask a currently listed application to quit normally.", arguments: ["pid": "PID from windows state.", "expected_bundle_identifier": "Exact bundle identifier from current windows state."], destructive: true),
